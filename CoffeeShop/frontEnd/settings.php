...
<body>
    ...
    <div class="top-div">
		...
		<div class="dropdown-content">
			...
			<a href="logout_proc.php"> <img src="../Accessories/logout_FILL1_wght100_GRAD-25_opsz48.png" alt=""> Sign out</a>
		</div>
	    </div>
    </div>
	...
	<form action="../procFiles/deleteAccount_proc.php" method="GET">
	  <input class="delete" type="submit" name="delete_account" value="Delete Account">
	</form> 
...
<body>
	...
	<form action="deleteAccount_proc.php" method="GET">
